...
export const faq: Pregunta[] = [
  ...
  },
  {
    ...
    respuesta:
      "Sí. El dominio se registra siempre a tu nombre, desde el primer día. Es tu marca y sigue siendo tuyo si cancelas.",
  },
  {
  ...
  },
  {
    ...
    respuesta:
      "Cimiento: 5-7 días laborables. Torre: 7-10 días laborables. Alcazaba: 15-20 días laborables. Medina: 20-30 días laborables. El plazo empieza cuando tenemos los textos, accesos y material necesarios para construir tu web.",
  },
  {
  ...
  },
  {
    ...
    respuesta:
      "Sí. Subir es inmediato: solo pagas la diferencia de lo que hay que construir, nunca la obra entera otra vez, y te decimos esa cifra antes de decidir. El precio con compromiso implica 12 meses nuevos desde la fecha del cambio. Al terminar tu permanencia puedes bajar con 30 días de aviso: todo lo construido sigue ahí; solo cambia el trabajo mensual. Si tienes un mes complicado, podemos pausar el servicio al 50% durante dos meses. Tu cuota no sube durante los primeros 24 meses, salvo que cambies de plan. El Círculo de Alarifes permite ganar una congelación de por vida como excepción a esa garantía general.",
  },
];
